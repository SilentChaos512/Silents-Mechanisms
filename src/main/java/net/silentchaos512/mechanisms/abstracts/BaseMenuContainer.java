...
public abstract class BaseMenuContainer extends AbstractContainerMenu {
    ...
    public BaseMenuContainer(@Nonnull MenuType<?> pMenuType, int pContainerId, Inventory playerInventory, Container container, Supplier<? extends Block> blockAccess, ContainerData data) {
        super(pMenuType, pContainerId);
        this.playerInventory = playerInventory;
        this.container = container;
        this.blockAccess = blockAccess.get();
