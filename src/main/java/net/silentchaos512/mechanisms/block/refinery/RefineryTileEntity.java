...
public class RefineryTileEntity extends AbstractFluidMachineTileEntity<RefiningRecipe> implements IFluidInventory {
    ...
    public RefineryTileEntity() {
        super(ModTileEntities.refinery, 4, 5, TANK_CAPACITY, MachineTier.STANDARD.getEnergyCapacity(), 500, 0, MachineTier.BASIC);
    }
    ...
    private boolean canMachineRun(RefiningRecipe recipe) {
        return world != null
                ...
                && hasRoomInOutput(recipe.getFluidResults(this))
