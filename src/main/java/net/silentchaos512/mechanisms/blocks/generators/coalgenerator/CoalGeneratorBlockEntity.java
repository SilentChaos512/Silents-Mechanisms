...
import net.silentchaos512.mechanisms.abstracts.BaseMachineBlockEntity;
import net.silentchaos512.mechanisms.abstracts.TickableBlockEntity;
import net.silentchaos512.mechanisms.capability.GeneratorEnergyStorage;
...
public class CoalGeneratorBlockEntity extends BaseMachineBlockEntity implements TickableBlockEntity {
    ...
    public CoalGeneratorBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(ModBlockEntities.COAL_GENERATOR.get(), pWorldPosition, pBlockState, new GeneratorEnergyStorage(ENERGY_CAPACITY, ENERGY_PER_TICK, MAX_EXTRACT), 1);
    }
    ...
    public Component getDisplayName() {
        return ModBlocks.COAL_GENERATOR.get().getName();
    }
