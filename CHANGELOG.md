...
## [1.0.1] - 2021-04-11
### Fixed
- Crash with latest JEI (7.6.3) [#139]
- Improved rendering performance of canisters [#105]

## [1.0.0] - 2021-04-09
### Added
- Config to blacklist oil lakes by dimension [#120]
- Infuser textures
...
## [0.8.5] - 2020-10-28
### Fixed
- A crash with recent Forge versions [#117]
...
- Recipes with fluid tags causing "Tag not bound" exceptions (hacky workaround, hopefully doesn't break anything...)
